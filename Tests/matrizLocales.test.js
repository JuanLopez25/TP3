...
test("Crear matriz de locales", () =>{
    ...
    var numDestinos=matriz.locales[0].centrosCreados[4].nombre+matriz.locales[1].centrosCreados[4].nombre+matriz.locales[2].centrosCreados[4].nombre+matriz.locales[3].centrosCreados[4].nombre;
